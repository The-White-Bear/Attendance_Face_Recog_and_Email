...
import pickle
import openpyxl
path = r'D:/Work_space/face-recog-attendance-master/student_images'
attendee = []
images = []
classNames = []
...
def write_to_excel(name):
    wb = openpyxl.load_workbook(
        "D:/Work_space/face-recog-attendance-master/Book2.xlsx")
    ws = wb['Sheet1']
    col_name = chr(ord('D') + col_number)  # Chuyển đổi số buổi thành ký tự cột (D, E, F, ...)
    cell_name = f"{col_name}1"  # Ô hàng 1 của cột điểm danh thứ i
    ...
    wb.save("D:/Work_space/face-recog-attendance-master/Book2.xlsx")
